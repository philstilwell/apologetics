...
Static GitHub Pages apps that examine recurring weaknesses in Christian apologetics arguments.
...
This project is dependency-free and can be served from the repository root.
