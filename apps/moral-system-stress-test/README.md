...
The app now keeps the user focused on identifying the required structure of an objective moral system and assessing whether a Christian account substantiates that structure.
