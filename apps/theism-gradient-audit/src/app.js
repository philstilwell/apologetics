...
function buildFinalReport() {
  ...
  return [
    ...
    "",
    "Score key:",
    "- C = Confidence: how credible or supportable the claim seems to you.",
    "- P = Personal substantiation: how well you can personally make a responsible case for the claim using reasons, evidence, examples, comparisons, and answers to major alternatives.",
    "- Personal substantiation is not mere agreement, sincerity, inherited confidence, community confidence, or reliance on what a stronger advocate could argue.",
    "- Substantiation gap = C minus P; a large gap means confidence is outrunning your own present ability to substantiate the claim.",
    "",
...
function buildAiPrompt() {
  ...
  return [
    ...
    "- Personal substantiation: the user's own present ability to make a responsible case for a claim using reasons, evidence, examples, comparisons, and answers to major alternatives; it is not mere agreement, sincerity, inherited confidence, community confidence, or reliance on what a stronger advocate could argue.",
