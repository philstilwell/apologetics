...
function buildSummaryOutput(scenario, scenarioState, standings, lastEvent) {
  ...
  const lines = [
    ...
    "5. Image prompt: end with this exact final line and nothing more:",
    "\"Create a salient and stylish landscape-oriented infographic that reflects the central concept(s)/argument(s) in the previous output.\"",
    "",
    "Do not write an essay. Do not sound formal. Do not use headers other than the five labels above.",
    "Do not add anything before or after that image-prompt line.",
    "",
    "Current run data:",
    `- Field: ${scenario.name}`,
