...
function buildSummaryOutput(scenario, scenarioState, standings, lastEvent) {
  ...
  const lines = [
    ...
    "",
    "Task:",
    "- Write a concise but substantive analysis of the current run.",
    ...
    "- Explain that more faith means a greater willingness to overcommit beyond support, which makes the policy less truth-tracking and more costly.",
    "- Explicitly note that short lucky bursts or temporary leads do not vindicate faith, because stochastic systems can briefly reward worse methods.",
    "- Make clear that the structural lesson is about method quality over repeated trials, not about one deterministic sequence.",
    "",
    "Constraints:",
    ...
    "- Stay grounded in the data below, but draw the broader epistemic lesson the simulation is meant to illustrate.",
    ...
    "1. One short paragraph stating the main verdict.",
    "2. One short paragraph explaining what the current data shows.",
    "3. One short paragraph explaining why stochastic short-term wins do not rescue faith as a method.",
    "4. A brief concluding paragraph on why any ideology that encourages belief beyond perceived evidence is, on this definition, epistemically suspect or likely false.",
    "",
    "Current run data:",
    `- Field: ${scenario.name}`,
